...
/**
 * Generator rendering the navigation menu for demo pages.
 */
class Menu extends PageGenerator
{
    /**
     * Builds the page and renders it immediately.
     *
     * @param ApplicationDeTest $application Active application instance.
     */
    public function __construct(ApplicationDeTest $application)
    {
        parent::__construct(new Templating("menu", "menu.html"));
        $active = "ACTIVE_" . strtoupper($_SESSION[$application->sessionPage]??"ACCUEIL");
