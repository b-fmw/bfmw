...
use applicationTest\repository\Etudiants;
use bfmw\core\PageGenerator;
use bfmw\templating\Templating;

/**
 * Generator rendering the limited layout example page.
 */
class Limited extends PageGenerator
{
    /**
    ...
    {
        parent::__construct(new Templating("limited", "limited.html"));
        $application->getAuthenticators()->breakSession();
        $this->engine->affectToBlocAndRepeat("un_etudiant",new Etudiants()->getEtudiantsDuDepartement(1,10));
